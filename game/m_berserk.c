...
mframe_t berserk_frames_paused[] =
{
	ai_walk, 0, NULL,
	ai_walk, 0, NULL,
	ai_walk, 0, NULL,
...
mframe_t berserk_frames_freeze[] =
{
	ai_run,0, NULL,
	ai_run, 0, NULL,
	ai_run, 0, NULL,
...
mmove_t berserk_move_freeze = { FRAME_run1, FRAME_run6, berserk_frames_freeze, NULL };
...
void berserk_run (edict_t *self)
{
	...
	if (self->pause > 0)
		self->monsterinfo.currentmove = &berserk_move_freeze;
	else
